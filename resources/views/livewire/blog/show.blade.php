            ...
            @foreach ($blog as $item)
                <tr class="">
                    <td class="border-b text-body border-gray-300 px-4 py-2">
                        <div class="flex justify-center">{{ $loop->iteration }}</div>
                    </td>
                    <td class="border-b text-body border-gray-300 px-4 py-2">
                        <div class="flex justify-center">
                            <img src="{{ asset('storage/thumbnails/' . $item->thumbnail) }}" alt="Thumbnail"
                                style="width: 174px; height: 110px;" class="w-full h-64 object-cover mb-4">
                        </div>
                    </td>
                    <td class="border-b text-body border-gray-300 px-4 py-2">
                        <div class="flex justify-center">{{ $item->judul_blog }}</div>
                    </td>

                    <td class="border-b text-body border-gray-300 px-4 py-2">
                        <div class="flex justify-center">{{ $item->kategori->nama_kategori ?? 'Tidak Ada Kategori' }}
                        </div>
                    </td>
                    <td class="border-b text-body border-gray-300 px-4 py-2">
                        <div class="flex justify-center">
