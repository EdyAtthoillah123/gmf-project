    ...
    <nav class="flex justify-between items-center w-full mx-auto py-3 relative">
        ...
        <div id="menu"
            ...
            <ul class="flex lg:flex-row flex-col lg:items-center gap-8 lg:flex-grow lg:justify-center">
                ...
                <li>
                    <a class="text-title2 text-dgreen hover:font-bold" href="#service">{{ __('messages.service') }}</a>
                </li>
                <li>
                ...
                <li class="lg:hidden flex gap-4 items-center">
                    ...
                    <a href="#" class="text-title2 text-dgreen font-bold border border-dgreen rounded-full px-3 py-2">ID</a>
                    {{-- Instagram --}}
